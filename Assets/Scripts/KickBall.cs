...
public class KickBall : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // Hook up Done button (loads scene 0)
        DoneButton = uiDocument.rootVisualElement.Q<Button>("Done");
        if (DoneButton != null)
        {
    ...
    void OnDestroy()
    {
        ...
        // Remove UI callbacks if assigned
    ...
    // Public method for Done button - loads scene index 0
    public void Done()
    {
