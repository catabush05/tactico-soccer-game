...
- Tutorial
- 8 levels with increasing difficulties
- Pass functionality
...
### Assets Used
All assets were hand-drawn and created for the purposes of this game!

### Technical Details
Built in Unity 6.2. Packages: Cinemachine, TextMeshPro.

### Known Issues
- Sideline detection can sometimes be faulty
